...
public class PixelmonOverlayAPI implements EventListener<ChangeServiceProviderEvent> {
	...
	void display(EnumOverlayLayout layout, OverlayGraphicType type, List<String> lines, @Nullable Long duration, @Nullable String spec, @Nullable ItemStack itemStack) {
